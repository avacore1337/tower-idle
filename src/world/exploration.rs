        ...
        match self.damage {
            Damage::End(damage) => {
                game.intermediate_state
                    .add_base(KeyValues::HealthDrain, damage, "Exploration damage");
            }
            _ => {}
        }
        match self.explore {
